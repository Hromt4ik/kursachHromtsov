# Generated by Django 4.1.3 on 2023-12-11 16:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Клиент', 'Клиент'), ('Сотрудник', 'Сотрудник'), ('Водитель', 'Водитель'), ('Администратор', 'Администратор')], default='Клиент', max_length=200, verbose_name='Роль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('На базе', 'На базе'), ('Назначен водитель', 'Назначен водитель'), ('Ремонт', 'Ремонт'), ('Списана', 'Списана')], default='На базе', max_length=200, verbose_name='Статус')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Packages_as_employee', to=settings.AUTH_USER_MODEL, verbose_name='Сотрудник')),
